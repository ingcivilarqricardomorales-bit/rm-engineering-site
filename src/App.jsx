...
export default function App() {
  const services = [
    {
      ...
      desc:
        "Anteproyecto, modelado BIM (LOD 300–400), planos constructivos y especificaciones técnicas.",
    ...
    },
    {
      ...
      desc:
        "Sistemas de agua potable, pluvial y sanitaria cumpliendo UPC/IPC. Memorias y isométricos.",
  ...
  const projects = [
    {
      title: "Torre Residencial – Panamá",
      tag: "Estructuras",
      metric: "−12% acero vs. base",
      img: "https://picsum.photos/seed/torre/800/600",
    },
    {
      title: "Planta de proceso – IDF",
      tag: "Hidrosanitarias",
      metric: "+18% eficiencia hidráulica",
      img: "https://picsum.photos/seed/planta/800/600",
    },
    {
      title: "Residencia – Boquete",
      tag: "Arquitectura",
      metric: "Entrega en 8 semanas",
      img: "https://picsum.photos/seed/casa/800/600",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <section id="services" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="mt-2 max-w-2xl text-gray-600">
          Soluciones llave en mano con entregables verificables. Incluimos memoria de cálculo,
      ...
      <section id="contact" className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="rounded-3xl border border-black/10 bg-white shadow-sm p-8">
          ...
          <p className="mt-2 text-gray-600">
            Cuéntanos tu proyecto. Respondemos entre 24 y 72 horas hábiles.
          </p>
